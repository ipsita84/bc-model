...
def main():
    ...
    sizes = [6,8,10,12,16,18,20,24,30,32]
    Dmin = 1.88
    Dmax = 1.91
    N_D = 30
        ...
        for S in sizes:
            for R in range(S):
                ...
                if jnum >= jmin and jnum < jmax:
                    ...
                    sp.call('sqsub --mpp 2500M -r 168h -q NRAP_893 -e run%d.err -o run%d.out ./transfer %d %d %f' % (jnum, jnum, S, R, D), cwd=cur_path, shell=True)
                jnum += 1
